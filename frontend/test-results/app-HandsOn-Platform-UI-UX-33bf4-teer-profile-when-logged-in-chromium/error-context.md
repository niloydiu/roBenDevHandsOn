...
- Name: app.spec.ts >> HandsOn Platform UI/UX & E2E Tests >> Profile page requires authentication when logged out and displays volunteer profile when logged in
- Location: tests\app.spec.ts:103:7
...
Locator: getByText('Volunteer Hours')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Volunteer Hours')
...
- banner:
  ...
  - link "Join Now":
    - /url: /signup
- heading "Authentication Required" [level=2]
- paragraph: Please sign in to access your volunteer profile, badges, and activity history.
- link "Sign In":
  - /url: /login
- link "Create Account":
  - /url: /signup
