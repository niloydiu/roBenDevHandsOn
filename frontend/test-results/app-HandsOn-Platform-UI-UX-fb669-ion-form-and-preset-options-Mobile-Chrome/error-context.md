...
- Name: app.spec.ts >> HandsOn Platform UI/UX & E2E Tests >> Support page renders donation form and preset options
- Location: tests\app.spec.ts:62:7
...
Locator: locator('h2')
Expected substring: "Support Our Platform"
