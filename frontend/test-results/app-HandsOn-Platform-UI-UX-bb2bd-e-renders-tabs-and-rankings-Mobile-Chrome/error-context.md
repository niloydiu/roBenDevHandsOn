...
- Name: app.spec.ts >> HandsOn Platform UI/UX & E2E Tests >> Teams page renders tabs and rankings
- Location: tests\app.spec.ts:48:7
...
Locator: locator('h1')
Expected substring: "Volunteer Teams"
Received string:    "404"
Timeout: 5000ms
