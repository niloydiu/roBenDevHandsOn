...
const Home = () => {
  return (
    <PageWrapper>
      ...
      {/* Stats / Proof Section */}
      <section className="py-12 bg-white dark:bg-slate-900 border-y border-slate-100 dark:border-slate-800/30">
        <div className="container mx-auto px-4 lg:px-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { label: "Active Volunteers", val: "2,400+", color: "text-blue-600 dark:text-blue-400" },
              { label: "Hours Donated", val: "15k+", color: "text-green-600 dark:text-green-400" },
              { label: "Impact Projects", val: "450+", color: "text-orange-600 dark:text-orange-400" },
              { label: "Lives Touched", val: "10k+", color: "text-purple-600 dark:text-purple-400" },
            ].map((stat, i) => (
      ...
      {/* Featured Events */}
      <section className="section-padding bg-slate-50 dark:bg-slate-950/40 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white leading-tight">
                Make an impact <br />in your <span className="text-blue-600 dark:text-blue-400">Neighborhood</span>.
              </h2>
            </div>
            <Link
              href="/events"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 sticky top-32">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-xs font-bold uppercase tracking-widest mb-4">
                  <HiOutlineHeart /> Direct Mutual Aid
                </div>
                <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-6 font-display">
                  Hearts needing <br />a <span className="text-blue-600 dark:text-blue-400">Helping Hand</span>.
                </h2>
      ...
      <section className="section-padding bg-slate-50 dark:bg-slate-950/40">
        <div className="container mx-auto px-4 lg:px-10">
          <div className="bg-blue-600 dark:bg-indigo-900 rounded-[48px] p-8 md:p-16 lg:p-20 relative overflow-hidden shadow-2xl shadow-blue-200 dark:shadow-none">
            {/* Background design */}
            ...
            <div className="max-w-4xl relative z-10">
              ...
              <p className="text-blue-100 dark:text-indigo-200 text-lg md:text-xl mb-12 max-w-2xl leading-relaxed">
